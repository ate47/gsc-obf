...
namespace utils::cli_options {
    class CliOption {
        const char* longName;
        const char* smallName;
        const char* usage;
        const char* description;
        utils::logs::loglevel lvl;
        size_t len{};
      ...
      public:
        ...
        constexpr utils::logs::loglevel Level() { return lvl; }
    ...
    class CliOptions {
      ...
      public:
        ...
        CliOptions& addOption(
            ...
            const char* smallName = nullptr, utils::logs::loglevel lvl = utils::logs::loglevel::LVL_INFO
        ) {
